#!/usr/bin/env python
SERIALPORT = "COM20" #None = Auto-detect, to specify a specific serial port, you can set it to something like "/dev/ttyACM0" (Linux) or "COM1" (Windows)
...
mqtt = None #InkkeysMqtt("192.168.2.5", DEBUG) #Set address to "None" if you do not want to use mqtt
